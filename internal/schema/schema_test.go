...
func fillDefaultObjectOwners(s Schema) Schema {
	...
	for i := range s.CompositeTypes {
		if s.CompositeTypes[i].Owner == "" {
			s.CompositeTypes[i].Owner = "postgres"
		}
	}
